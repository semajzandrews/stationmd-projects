    ...
    <Html>
      ...
      <Body style={{ fontFamily: 'Helvetica,Arial,sans-serif', backgroundColor: '#f5f7fa', margin: '0', padding: '0' }}>
        <Container style={{ maxWidth: '600px', margin: '0 auto', backgroundColor: '#ffffff' }}>
          ...
          <Section style={{ padding: '20px 20px 40px 20px', backgroundColor: '#f0f8ff', textAlign: 'center' }}>
            <Text style={{ color: '#4A72A0', fontSize: '28px', margin: '0 0 15px 0', fontWeight: 'bold' }}>Employee Onboarding Checklist</Text>
            <Text style={{ color: '#4a5568', fontSize: '16px', lineHeight: '1.6', margin: '0 0 25px 0' }}>Complete your onboarding checklist to get started with StationMD.</Text>
            <Button href="#" style={{ display: 'inline-block', backgroundColor: '#4A72A0', color: '#ffffff', fontSize: '18px', fontWeight: 'bold', textDecoration: 'none', padding: '15px 30px', borderRadius: '5px' }}>View Checklist</Button>
          </Section>
